...
public class UserApp
{
   ...
   public static void main(String[] args) throws Exception
   {
      ...
      Yaks yaks = Yaks.getInstance("is.yaks.YaksSocketImpl", Camera.class.getClassLoader(), "host=128.10.0.3", "port=8448");
      ...
      String[] matchingVideoChunksKeys = access.get(Path.ofString("//com.huawei/shenzen/mlapps/pics_db?pic="+personImgVector), String[].class);
