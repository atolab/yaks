...
public class Analytic implements Listener<byte[]>
{
   ...
   public void init()
   {
      ...
      this.yaks = Yaks.getInstance("is.yaks.YaksSocketImpl", Camera.class.getClassLoader(), "host=128.10.0.2", "port=8448");
      ...
      access.eval(Selector.ofString("//com.huawei/shenzen/mlapps/pics_db"),
            p -> match_func(p));
   }
   ...
   public String[] findMatchingVideoChunk(String personImgVector)
   {
      ...
      String[] result = {
            "//com.huawei/shenzen/videoapps/camera/123/chunk-1531492128",
